						                       ...
						                       echo '  <div class="col-xs-12 col-sm-6 col-md-3 food-item">
														<div class="food-item-wrap">
															...
															<div class="content">
																...
																<div class="price-btn-block"> <span class="price">'.$r['price'].' Tk</span>
                                                                <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn btn-success pull-right">Order Now</a> </div>
															</div>
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                ...
                                <div class="step step-1">
                                    ...
                                    <p>We got you covered with more than 40+ popular delivery restaurants.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>We are serving you more than 300+ popular dish varieties.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered within 1 hour and enjoy your meal..!</p>
                            </div>
                        </div>
                    </div>
                </div>
